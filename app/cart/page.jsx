...
const page = () => {
  ...
  if (loggedInUser) {
    ...
    <div className="container 2xl:px-8 px-2 mx-auto">
      ...
      <div className="w-full sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1280px] 2xl:max-w-[1536px] mx-auto grid gap-8 sm:gap-4 lg:gap-8 p-2 grid-cols-1 lg:grid-cols-custom">
