...
const Navbar = () => {
  ...
  return (
    <div className="md:flex md:flex-row md:justify-between text-center text-sm sm:text-base mx-10 my-10">
      ...
      <div className="mt-2">
        ...
        {loggedInUser && (
          <Link
            href="/cart"
            className="bg-purple-600 text-gray-50 hover:bg-purple-700 p-3 px-3 sm:px-5 rounded-full block sm:inline w-28 mx-auto"
          >
            <svg
